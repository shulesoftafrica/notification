-- PostgreSQL Test Data Setup for Notification Service
-- Execute this in PostgreSQL (psql) to create test data

-- Connect to notification_service database first:
...
-- Check PostgreSQL version and features
SELECT version();
